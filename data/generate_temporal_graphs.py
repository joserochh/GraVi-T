...
if __name__ == "__main__":
    ...
    if args.dataset == "50salads":
        ...
        # python data/generate_temporal_graphs.py --dataset SumMe --features google_pool5 --tauf 10
        path_dataset = os.path.join(args.root_data, f'annotations/{args.dataset}/eccv16_dataset_{args.dataset.lower()}_{args.features}.h5')
        ...
        for split_i in range(1, 6):
            ...
            path_graphs = os.path.join(args.root_data, f'graphs/{args.dataset}_{args.tauf}_{args.skip_factor}/split{split_i}')
            os.makedirs(os.path.join(path_graphs, 'train'), exist_ok=True)
            os.makedirs(os.path.join(path_graphs, 'val'), exist_ok=True)
